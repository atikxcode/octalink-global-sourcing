...
const Dashboard = () => {
  ...
  return (
    ...
    <aside className="flex font-sans flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 hidden md:hidden lg:block xl:block">
      ...
      <aside className={`fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 transition-transform duration-300 ease-in-out`}>
